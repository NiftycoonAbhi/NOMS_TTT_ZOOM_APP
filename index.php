    ...
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <div class="registration-card card mb-4">
          <div class="card-body">
            <h5 class="card-title"><i class="bi bi-pencil-square"></i> Student Registration Form</h5>
              ...
              <div class="col-md-12">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="meeting_id" id="meeting_id" class="form-control"
                    placeholder="Enter Meeting ID (e.g. 87185382135)" value="<?= htmlspecialchars($meetingId) ?>"
                    required>
                </div>
              </div>
        ...
        <div class="container d-flex justify-content-center align-items-center mt-5">
          <div class="card shadow-sm p-4 w-100" style="max-width: 500px;">
            <h3 class="text-center mb-4">Student Selection Form</h3>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              echo "You selected <strong>Branch:</strong> $branch<br><strong>Course:</strong> $course<br><strong>Batch:</strong> $batch";
              echo "</div>";
            }
            ?>
          </div>
          ...
          <div class="registration-card card mt-4">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h5 class="mb-0">
                ...
                <span
                  class="badge badge-count rounded-pill bg-primary ms-2"><?= count($currentMeetingRegistrations) ?></span>
              </h5>
                      ...
                      <?php foreach ($currentMeetingRegistrations as $id => $registration): ?>
                        <tr>
                          ...
                          <td>
                            ...
                            echo $date->format('d M Y h:i A'); // Example: 15 Jun 2023 02:30 PM
                            ?>
                          </td>
                          <td class="action-buttons">
                            <?php if (!empty($registration['zoom_link'])): ?>
                              <button class="btn btn-sm btn-success"
                                onclick="window.open('<?= htmlspecialchars($registration['zoom_link']) ?>', '_blank')"
                                title="Join Meeting">
